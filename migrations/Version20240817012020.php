 ...
 */
final class Version20240817012020 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE step (id INT AUTO_INCREMENT NOT NULL, post_id INT DEFAULT NULL, step_content LONGTEXT NOT NULL, INDEX IDX_43B9FE3C4B89032C (post_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
